...
public class TampilDetilAbsenKeluar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_detil_absen_keluar);
    ...
    private void getAbsen() {
        class GetAbsen extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TampilDetilAbsenKeluar.this, "Fetching...", "Wait...", false, false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam(Server.URL_GET_PLG, idabsen);
                return s;
            }
        }
    ...
    public void back(View view) {
        startActivity(new Intent(TampilDetilAbsenKeluar.this,TampilAbsenKeluar.class));
    }
}