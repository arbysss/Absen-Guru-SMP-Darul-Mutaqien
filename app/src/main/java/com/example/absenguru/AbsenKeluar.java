...
public class AbsenKeluar extends AppCompatActivity {
    ...
    private String url = Server.URL + "absenkeluar.php";
    private static final String TAG = AbsenKeluar.class.getSimpleName();
    ...
    public void back(View view) {
        startActivity(new Intent(AbsenKeluar.this,MainActivity.class));
    }
