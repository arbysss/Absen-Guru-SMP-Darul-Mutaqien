...
public class TampilAbsenMasuk extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_absen_masuk);
    ...
    private void showAbsenmasuk(){
        ...
        ListAdapter adapter = new SimpleAdapter(TampilAbsenMasuk.this, list, R.layout.list_item,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TampilAbsenMasuk.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam(Server.URL_GET_ALL, idguru);
                return s;
            }
        }
    ...
    public void back(View view) {
        startActivity(new Intent(TampilAbsenMasuk.this,MainActivity.class));
    }
    @Override
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(TampilAbsenMasuk.this,TampilDetilAbsenMasuk.class);
